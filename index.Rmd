...
link-citations: yes
github-repo: byandell/SystemsEthology
description: "This is a bookdown version of Quantitative Population Ethology inspired by writing of Bland Ewing.
    The output format is bookdown::gitbook."
...
ethology' or 'quantitative population ethology', which
I now call 'systems ethology'.
The original unpublished manuscripts are all over 25 years old.
Nevertheless, the ideas fit nicely with current theories about
